<div class="relative md:mx-auto " x-data="window.oZcfXWmBuWfxbIo" x-init="initialize()">
    ...
    <div class="bg-white dark:bg-zinc-800 shadow-sm ring-1 ring-gray-100 dark:ring-zinc-700  dark:border-zinc-700 rounded-xl px-4 py-3 lg:px-8 lg:py-8">
            ...
            <div class="max-w-2xl mx-auto mt-6 md:mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                ...
                <div class="flex flex-col-reverse">
                    ...
                    <div class="mt-4">
                        ...
                        <h1 class="text-xl font-extrabold tracking-wide leading-8 text-black dark:text-white lg:text-4xl">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                    ...
                    <button 
                        ...
                        class="w-full text-base font-medium flex justify-center bg-primary-600 hover:bg-primary-700 text-white py-4 px-8  tracking-wide focus:outline-none focus:shadow-outline cursor-pointer rounded-full"
                        >
                    ...
                    <a href="<?php echo e(url('messages/new', $gig->owner->username), false); ?>" target="_blank" class="w-full bg-primary-100 border border-transparent rounded-full py-4 px-8 flex items-center justify-center text-base font-medium text-primary-600 hover:bg-primary-200 focus:outline-none"><?php echo e(__('messages.t_contact_seller'), false); ?></a>
                ...
                <div class="border-t border-gray-200 dark:border-zinc-700 mt-10 pt-10">
                    <h3 class="text-md font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('messages.t_actions'), false); ?></h3>
                    <div class="mt-4 text-gray-500">
                    ...
                    <div id="tab-panel-reviews" class="-mb-10" x-data="Components.tabPanel(0)" aria-labelledby="tab-reviews" x-init="init()" x-show="selected" @tab-select.window="onTabSelect" role="tabpanel" tabindex="0">
                        ...
                        <div class="py-6">
                            <?php $__currentLoopData = $gig->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($tag): ?>
                                    <a href="<?php echo e(url('search?q=' . $tag->name), false); ?>" class="mb-3 text-xs font-semibold inline-block py-2 px-4 rounded-full text-slate-600 dark:text-zinc-400 bg-gray-100 dark:bg-zinc-700 dark:hover:bg-zinc-600 hover:bg-gray-200 last:mr-0 ltr:mr-1 rtl:ml-1">
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/main/service/service.blade.php ENDPATH**/ ?>