            ...
            <ul class="space-y-3">
                ...
                <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(!$link['childs']): ?>
                        ...
                        <li class="relative px-4 flex items-center group py-2">
                            <a href="<?php echo e($link['href'], false); ?>" class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100 hover:bg-[#F0EEFF] rounded-full py-1 px-2">

                                
                                <div class="h-6 w-6 bg-gray-50 border border-gray-100 flex items-center justify-center  rounded-full">
                                    <?php echo $link['icon']; ?>

                                </div>

                                
                                <span class="ltr:ml-4 rtl:mr-4 text-[15px] font-medium text-gray-600 group-hover:text-gray-900"><?php echo e($link['text'], false); ?></span>
                    ...
                    <?php else: ?>
                        ...
                        <li class="relative px-4 group" x-data="{ open: false }">
                            <button
                                class="inline-flex h-full items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 focus:outline-none hover:bg-[#F0EEFF] rounded-full py-1 px-2 group"
                                x-on:click="open = !open" aria-haspopup="true">
                                <span class="inline-flex items-center rounded-full">

                                    <div class="h-7 w-7 bg-gray-50 border border-gray-100 flex items-center justify-center rounded-full group-hover:bg-[#5F4BDB]">
                                        <?php echo $link['icon']; ?>
                                ...
                                <svg class="w-5 h-5 group-hover:text-[#5F4BDB]" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path> </svg>
                            </button>
                            <template x-if="open">
                                <ul x-transition:enter="transition-all ease-in-out duration-300"
                                    ...
                                    <?php $__currentLoopData = $link['childs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="px-4 py-3 transition-colors text-[14px]
                                         duration-150 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-[#F0EEFF] rounded-full !mt-0">
                                ...
                                <ul x-transition:enter="transition-all ease-in-out duration-300"
                                    ...
                                    <?php $__currentLoopData = $link['childs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                            <a class="w-full block font-medium text-[#14px]" href="<?php echo e($child['href'], false); ?>"><?php echo e($child['text'], false); ?></a>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/admin/includes/sidebar.blade.php ENDPATH**/ ?>