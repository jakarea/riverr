<div class="mx-auto max-w-screen-md px-4 py-16 sm:px-6 lg:px-8 rounded-xl"  style="box-shadow: 0px 2px 28px rgba(62, 53, 120, 0.04)">
...
unset($__errorArgs, $__bag); ?>
			...
			<div class="col-span-12">
				<button type="submit" wire:loading.attr="disabled" wire:target="login" :disabled="!form.email || !form.password" class="w-full bg-primary-600 enabled:hover:bg-primary-700 text-white py-4.5 px-4 text-base font-semibold tracking-wide disabled:bg-zinc-200 disabled:text-zinc-500 rounded-full">
...
<?php $__env->startPush('scripts'); ?>
	...
	<?php endif; ?>
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/admin/auth/login.blade.php ENDPATH**/ ?>