                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-5/6 flex items-center">
                    <div class="w-full lg:mt-20">
                        ...
                        <div class="mt-10 sm:mt-12">
                            ...
                            {{-- Search form --}}
                            <form class="flex items-center mb-4 w-2/4" action="{{ url('search') }}" accept="GET">   
                                ...
                                <ul class="flex ltr:ml-3 rtl:mr-3">
                                    @foreach ($popular_tags as $tag)
                                        <li class="flex ltr:mr-3 rtl:ml-3 whitespace-nowrap">
                                            <a href="{{ url('categories', $tag->slug) }}" class="border-2 border-dark rounded-[40px] hover:bg-white hover:text-gray-700 transition-all duration-200 px-3 py-0.5 text-xs">
                                                {{ $tag->name }}
                                            </a>
                                        </li>
                                    @endforeach
