            ...
            <div class="col-span-12 mt-6 xl:mt-6 mb-16">
                ...
                <div class="flex w-9/12 justify-center mx-auto mt-12" wire:ignore>
                    ...
                    <a href="{{ url('categories', $category->slug) }}" 
                        ...
                        <img src="{{ placeholder_img() }}" data-src="{{ src($category->image) }}" alt="{{ $category->name }}" class="lazy w-20 h-20 rounded-lg mb-5">

                        <h5 class="text-[#363848] font-semibold text-3xl">{{ $category->name }}</h5>
                        <p class="text-[#363848] font-normal text-base mt-4">{{ $category->description }}</p> 
                    </a>
                    @endforeach     
                </div>
            </div>
            ...
            <div class="col-span-12 mb-16">
                ...
                <div class="block mb-6">
                    <div class="flex justify-between items-center bg-transparent py-2">
                        ...
                        <div>
                            <a href="{{ url('explore/projects') }}" class="text-white hover:text-[#363848] transition-colors duration-300 hidden rounded-full md:block dark:text-gray-100 dark:hover:text-white bg-[#5F4BDB] font-semibold text-base py-3 px-10 ml-4 hover:bg-[#F0EEFF] min-w-fit">
                                {{ __('messages.t_view_more') }}
            ...
            <div class="col-span-12">
                <div class="bg-[#1F2131] relative z-10 dark:bg-zinc-800 rounded-md flex items-center py-24 px-20">
                    <div class="w-full flex items-center">
                        <h3 class="text-white text-[44px] font-semibold w-3/5">{{ __('messages.t_dont_miss') }}</h3> 
                        <div class="mt-4 sm:mt-6 sm:flex w-2/5 relative">
                            <label for="email-address" class="sr-only">Email address</label>
                            <input wire:model.defer="email" id="email-address" type="text" autocomplete="email" required="" placeholder="{{ __('messages.t_enter_email_address') }}" class="h h-[4.5rem] appearance-none min-w-0 w-full bg-transparent dark:bg-zinc-700 border border-[#363843] dark:border-zinc-700 placeholder:text-secondary-100 focus:outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-600 rounded-full text-white text-lg pl-6" readonly onfocus="this.removeAttribute('readonly');">
