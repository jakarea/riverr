    ...
    <div x-data="window.TTRjRvxLbHzaKxW">
        ...
        <div class="bg-[#5F4BDB] dark:bg-primary-600">
            <div class="max-w-screen-2xl mx-auto h-10 flex items-center justify-between sm:px-6 px-4 lg:px-16">
                ...
                {{-- Welcome back --}}
                <span class="italic font-normal text-white text-xs">@lang('messages.t_welcome'), {{
        ...
        <nav
            ...
            <div class="flex">
                ...
                <a href="{{ url('start_selling') }}"
                    ...
                    @lang('messages.t_become_a_member')
                </a>
            </div>
            @endguest
            ...
            <div
                ...
                <div class="w-full hidden lg:block">
                    <div class="relative max-w-lg" x-data="{ open: false }">
                        ...
                        <input wire:model.debounce.500ms="q" wire:keydown.enter="enter" x-ref="search"
                            ...
                            placeholder="{{ __('messages.t_search_here') }}" required>
                                    ...
                                    <ul class="-mx-4 mt-2 text-sm text-gray-700 dark:text-gray-400">
                                        ...
                                        <li class="group flex cursor-default select-none items-center px-4 py-2">
                                            <a href="{{ url('service', $gig->slug) }}" class="flex items-center">
                                                ...
                                                <span
                                                    class="ltr:ml-3 rtl:mr-3 flex-auto ext-ellipsis overflow-hidden">{{
                                                    $gig->title }}</span>
                                            </a>
                                        </li>
                                        @endforeach
                                    ...
                                    <ul class="-mx-4 mt-2 text-sm text-gray-700 dark:text-gray-400">
                                        ...
                                        <li class="group flex cursor-default select-none items-center px-4 py-2">
                                            <a href="{{ url('profile', $seller->username) }}" class="flex items-center">
                                                <img src="{{ placeholder_img() }}" data-src="{{ src($seller->avatar) }}"
                                                    alt="{{ $seller->username }}"
                                                    class="lazy h-6 w-6 flex-none rounded-full object-cover">
                                                <span class="ltr:ml-3 rtl:mr-3 flex-auto truncate">{{ $seller->username
                                                    }}</span>
                                            </a>
                                        </li>
                                        @endforeach
                ...
                <a href="{{ url('seller/orders') }}"
                    class="text-gray-500 hover:text-primary-600 dark:text-gray-100 dark:hover:text-white transition-colors duration-300 py-2 mx-4 relative hidden md:block">
                ...
                <div class="hidden md:inline-block relative ltr:ml-2 rtl:mr-4" x-data="{ open: false }">
                    ...
                    <div x-show="open" style="display: none" x-transition:enter="transition ease-out duration-150"
                        ...
                        <p class="py-3 px-3.5 truncate">
                            ...
                            <span class="font-semibold dark:text-white">@money(auth()->user()->balance_available,
                        ...
                        <div class="p-0">
                            ...
                            <a href="{{ url('seller/home') }}"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{
                                    __('messages.t_seller_dashboard') }}</span>
                        ...
                        <div class="p-o">
                            ...
                            {{-- Post a project --}}
                            @if (settings('projects')->who_can_post === 'both' || settings('projects')->who_can_post ===
                        ...
                        <div class="p-0">
                            ...
                            <a href="{{ url('profile', auth()->user()->username) }}"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{
                                    __('messages.t_view_profile') }}</span>
                            ...
                            <a href="{{ url('account/profile') }}"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{
                                    __('messages.t_edit_profile') }}</span>
                            ...
                            <a href="{{ url('account/settings') }}"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{
                                    __('messages.t_account_settings') }}</span>
                            ...
                            <a href="{{ url('account/password') }}"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{
                                    __('messages.t_update_password') }}</span>
                        ...
                        <div class="p-0">
                            ...
                            <a href="{{ url('account/verification') }}"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{
                                    __('messages.t_verification_center') }}</span>
                    ...
                    <li class="first:rounded-t-md">
                        <a href="{{ url('categories/' . $category->slug . '/' . $sub->slug) }}"
                            ...
                            <div class="flex-shrink-0 ltr:mr-2 rtl:ml-2">
                                <img class="w-7 h-7 lazy" src="{{ placeholder_img() }}" data-src="{{ src($sub->icon) }}"
                                    alt="{{ $sub->name }}">
                            </div>
                            @endif
                ...
                <div @class(['w-full overflow-auto h-full', 'pt-5'=> auth()->check()])>
                            ...
                            <details class="group ltr:ml-4 rtl:mr-4" wire:key="header-categories-{{ $category->uid }}">
                                ...
                                <summary class="flex items-center text-gray-500 dark:text-gray-300 py-2 px-5">
                                    ...
                                    <img src="{{ placeholder_img() }}" data-src="{{ src($category->icon) }}"
                                        alt="{{ $category->name }}" class="lazy h-6 w-6 rounded-full object-contain">
                    ...
                    <div x-data="{ open: false }" class="space-y-1">
                        ...
                        <div x-show="open" style="display: none" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div @if ($default_language_code !==$lang->language_code) wire:click="setLocale('{{
                                $lang->language_code }}')" @endif class="py-2 px-5 rounded-sm inline-flex items-center
                                cursor-pointer justify-between {{ $default_language_code === $lang->language_code ?
                                'bg-primary-100/25 text-primary-600' : 'hover:bg-gray-50 dark:hover:bg-zinc-600' }}
                                focus:outline-none w-full">
                                <div class="inline-flex items-center">
                                    <img src="{{ placeholder_img() }}" data-src="{{ countryFlag($lang->country_code) }}"
                                ...
                                <div class="ltr:ml-3 rtl:mr-3 w-0 flex-1">
                                    ...
                                    <div class="mt-2 flex space-x-7 rtl:space-x-reverse">
                                        ...
                                        <button wire:click="readNotification('{{ $n->uid }}')"
                                            wire:loading.attr="disabled" wire:target="read('{{ $n->uid }}')"
                                            type="button"
