<div class="w-full relative">
    ...
    {{-- Bid card --}}
    <div class="relative overflow-hidden py-6 px-5 rounded-[20px] bg-white mt-6 {{ $view_data['bid']['is_highlight'] ? 'ltr:border-l-8 rtl:border-l-8 border-amber-300' : '' }}" style="box-shadow: 0px 7px 22px 0px rgba(143, 134, 195, 0.07)">
            ...
            <div class="shrink-0">
                <div class="mt-4 sm:mt-0 sm:flex items-center justify-between sm:space-x-2 rtl:space-x-reverse">
                    ...
                    @if ($view_data['bid']['is_awarded'])
                        <div class="flex items-center space-x-2 rtl:space-x-reverse text-[13px] font-medium text-green-500 bg-green-100 px-3 py-2 rounded-full mb-2 sm:mb-0 justify-center">
                    ...
                    @if ($view_data['bid']['amount'] && $view_data['bid']['days'])
                        <span class="flex items-center text-sm font-normal text-gray-500 bg-gray-100 dark:bg-zinc-700 dark:text-zinc-400 px-3 py-2 rounded-full justify-center">
