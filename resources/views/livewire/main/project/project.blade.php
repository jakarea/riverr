<div class="w-full" x-data="window.LVoePqYZdmjQURo" x-init="initialize">
	...
	<div class="bg-[#5F4BDB] pt-14 pb-48 text-center">
		<h1 class="text-white text-3xl font-semibold">Job Details</h1>
		<ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 rtl:space-x-reverse sm:mb-0 mt-4">
			...
			<li aria-current="page">
				<div class="flex items-center text-white">
					/
					<span class="mx-1 text-sm font-medium text-white md:mx-2 dark:text-zinc-500 truncate max-w-[18rem]">
						{{ $project->title }}
					</span>
				</div>
			</li>
	...
	<div class="container max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-20 py-12 pt-16 pb-24 space-y-8 min-h-screen">
		{{-- Breadcrumbs --}}
		{{-- <nav
			class="hidden justify-between px-4 py-3 text-gray-700 rounded-lg sm:flex sm:px-5 bg-white dark:bg-zinc-700/40 dark:border-zinc-700 shadow"
		...
		<div class="-mt-56">
			<div class="grid grid-cols-4 gap-6">
				...
				<section class="">
					...
					{{-- Summary --}}
					<div
						class="overflow-hidden py-6 px-5 rounded-[20px] bg-white" style="box-shadow: 0px 7px 22px 0px rgba(143, 134, 195, 0.07)">

						{{-- Client details --}}
						<div class="flex items-center justify-center flex-col">
							<img class="w-32 h-32 rounded-full lazy object-cover" src="{{ placeholder_img() }}"
								data-src="{{ src($project->client->avatar) }}" alt="{{ $project->title }}">

							<div class="mt-6 text-center mb-5">
								<div class="text-xl font-semibold text-black capitalize">{{ $this->clientUsername() }}
								</div>
								<p class="text text-base font-normal text-[rgba(0, 0, 0, 0.7)]">{{
									$project->client->headline }}</p>
								<div class="text-xs text-gray-500 font-normal mt-2">
						...
						<div class="bg-white">
							...
							<dd class="text-center">
								...
								@case('active')
								<span
									class="bg-emerald-100 text-emerald-600 rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
								...
								<span
									class="bg-amber-100 text-amber-600  rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
								...
								@case('completed')
								<span
									class="bg-green-100 text-green-600  rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
								...
								@case('hidden')
								<span
									class="bg-gray-100 text-gray-600  rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
								...
								@case('rejected')
								<span
									class="bg-red-100 text-red-600  rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
								...
								<span
									class="bg-blue-100 text-blue-600  rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
								...
								<span
									class="bg-fuchsia-100 text-fuchsia-600  rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
								...
								@case('incomplete')
								<span
									class="bg-stone-100 text-stone-600  rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
								...
								@case('closed')
								<span
									class="bg-rose-100 text-rose-600  rounded-full py-2 px-5 font-semibold text-base block w-3/5 mx-auto text-center">
						...
						<div class="flex mt-8 items-center">
							<div class="bg-[#ECECEC] w-11 h-11 rounded-lg flex items-center justify-center mr-2">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
									class="w-4 h-4 text-md text-[#AEAEA]">
									<path
										d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z" />
								</svg>
							</div>
							<div>
								<h6 class="text-black font-bold text-base">{{ $project->client->city ?
									$project->client->city : 'N/A' }}</h6>
								<p class="text-[#AEAEA] font-normal text-md">Location</p>
							</div>
						</div>

						<div class="border-t border-[#EBEBEB] mt-8 pt-8">
							<h5 class="text-[#363848] text-base font-medium mb-4">About</h5>

							<p class="text-sm text-[#313131] font-normal">{{ $project->client->description }}</p>
						</div>
					</div>
				</section>
				...
				<div class="col-span-3">
					...
					<section class="w-full">
						<div class="bg-white rounded-[20px] p-12 " style="box-shadow: 0px 7px 22px 0px rgba(143, 134, 195, 0.07);">

							<div class="flex items-center justify-between mb-4">
								<div class="text-left">
									<h2 class="text-[#363848] font-semibold text-4xl">{{$project->title}}</h2>
									<h6 class="text-[#363848] font-noemal text-base mt-2">Posted on {{
										format_date($project->created_at, 'ago') }}</h6>
								</div>
								<div class="flex justify-end items-center">
									{{-- Bid Now --}}
									@auth
									@if (auth()->id() != $project->user_id && $project->status === 'active' &&
									!$already_submitted_proposal && auth()->user()->account_type === 'seller')
									<button id="modal-bid-button" type="button"
										class="text-white hover:text-[#363848] transition-colors duration-300 hidden rounded-full md:block dark:text-gray-100 dark:hover:text-white bg-[#5F4BDB] w-44 font-semibold text-base py-4 px-10 ml-4 hover:bg-[#F0EEFF] ">
										<span>@lang('messages.t_apply_now')</span>
									</button>
									@endif
									@endauth

									<button
										class="rounded-full flex items-center justify-center ml-4 focus:outline-none visited:outline-none w-14 h-14 bg-[#FFD9D9] group hover:bg-[#FF5353] transition-all">

										<div wire:loading.remove="">
											<svg class="w-7 h-7 text-[#FF5353] group-hover:text-white transition-all"
							...
							<div class="flex my-12">
								<div class="flex items-center mr-8">
									...
									<div
										class="w-14 h-14 rounded-full flex items-center justify-center bg-[#2bc155] mr-4">
									...
									<div>
										<span class="text-lg font-medium text-[#2E2E2E] block">
											@money($project->budget_min, settings('currency')->code, true) –
											@money($project->budget_max, settings('currency')->code, true)</span>
								...
								<div class="flex items-center mt-1">
									...
									<div
										class="w-14 h-14 rounded-full flex items-center justify-center bg-[#5F4BDB] mr-4">
										<svg class="w-6 h-6 text-white" stroke="currentColor" fill="currentColor"
											stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
											<path
												d="M11.707 2.293A.997.997 0 0 0 11 2H6a.997.997 0 0 0-.707.293l-3 3A.996.996 0 0 0 2 6v5c0 .266.105.52.293.707l10 10a.997.997 0 0 0 1.414 0l8-8a.999.999 0 0 0 0-1.414l-10-10zM13 19.586l-9-9V6.414L6.414 4h4.172l9 9L13 19.586z">
									...
									<div>
										<span class="text-lg font-medium text-[#2E2E2E] block">
											{{ $project->bids_count }} Bids</span>
										<span class="text-[#8A8A8A] font-normal text-base block">
											@money($avg_bid, settings('currency')->code, true) Avrage Bid
										</span>
							...
							<div class="mt-6">
								...
								{{-- Description --}}
								<h2 class="mb-4 text-base font-semibold text-[#363848]">
									{{ __('messages.t_description') }}
								</h2>
								<div class="text-[#363848] font-normal text-lg break-all"
								...
								<div class="mt-6">
									<h2 class="mb-4 text-base font-semibold text-[#363848]">
										@lang('messages.t_required_skills')</h2>
									@foreach ($project->skills as $skill)
									<a class="text-[#363848] hover:text-white transition-colors duration-300 rounded-full inline-block dark:text-gray-100 dark:hover:text-white bg-[#F0EEFF] font-semibold text-base py-3 px-10 hover:bg-[#5F4BDB] mr-4"
										href="{{ url('explore/projects/' . $project->category->slug . '/' . $skill->skill->slug) }}">
										{{ $skill->skill->name }}
									</a>
									@endforeach
								</div>
								...
								<div class="rounded-md bg-yellow-50 dark:bg-zinc-700 p-4 mt-10">
									<div class="flex">
										<div class="flex-shrink-0">
											<svg class="h-5 w-5 text-yellow-400 dark:text-zinc-400"
										...
										<div class="ltr:ml-3 rtl:mr-3">
											<h3 class="text-sm font-medium text-yellow-800 dark:text-zinc-100">{{
												__('messages.t_beware_of_scams') }}</h3>
					...
					<section class="relative mt-4">
						...
						<div class="sm:flex sm:items-center sm:justify-between">
							...
							{{-- Title --}}
							<div class="">
								<h2 class="mb-2 text-base font-semibold text-[#363848]">
							...
							<div class="flex items-center">
								...
								<div x-data="{ open: false }" class="relative inline-block">
									...
									<button type="button" aria-haspopup="true" x-bind:aria-expanded="open"
										...
										class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse rounded-full border font-semibold focus:outline-none px-3 py-2 leading-5 text-sm border-gray-300  text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-transparent dark:text-zinc-300 dark:hover:bg-zinc-600 bg-[#EEECFF]">
						...
						<div
							...
							<div class="w-52 h-52 bg-gray-50 rounded-full flex items-center justify-center">
								<svg class="w-40 h-40 text-zinc-400" xmlns="http://www.w3.org/2000/svg"
									...
									<circle id="fd1d2195-7e97-488f-8f4b-7061a06deb9a"
										...
										r="3.4425" fill="#fff" />
									<rect x="620.27691" y="144.28855" width="58.05212" height="4.36334"
										fill="#e6e6e6" />
									<rect x="620.27691" y="157.09784" width="89.64514" height="4.36332"
										fill="#e6e6e6" />
									<rect x="621.20899" y="169.29697" width="73.05881" height="4.36332"
										fill="#e6e6e6" />
									<rect x="620.27691" y="182.68222" width="42.65054" height="4.36332"
										fill="#e6e6e6" />
									<rect x="620.27691" y="195.75677" width="64.37073" height="4.36332"
										fill="#e6e6e6" />
									...
									<rect x="620.27691" y="208.91306" width="58.05212" height="4.36332"
										fill="#e6e6e6" />
									<rect x="620.27691" y="221.72236" width="89.64514" height="4.36332"
										fill="#e6e6e6" />
									<rect x="621.20899" y="233.92149" width="73.05881" height="4.36332"
										fill="#e6e6e6" />
									<rect x="620.27691" y="247.30674" width="42.65054" height="4.36332"
										fill="#e6e6e6" />
									<rect x="620.27691" y="260.38129" width="64.37073" height="4.36332"
										fill="#e6e6e6" />
									...
									<rect x="436.63003" y="243.13905" width="58.05213" height="4.36333"
										fill="#e6e6e6" />
							...
							<h2 class="mt-5 block text-sm font-semibold text-zinc-800">
								@lang('messages.t_this_project_is_closed_for_bidding')</h2>
							<a href="{{ url('explore/projects') }}"
								class="text-primary-600 text-[13px] hover:underline font-normal tracking-wide mt-1">@lang('messages.t_find_another_project')</a>
						</div>
						@else
						...
						{{-- Bid card --}}
						@livewire('main.cards.bid', ['bid_id' => $sponsored_bid->uid], key('bid-card-id-' .
						$sponsored_bid->uid))
		...
		<x-forms.modal id="modal-bid-container" target="modal-bid-button" uid="modal_{{ uid() }}"
			placement="center-center" size="max-w-4xl">
				...
				<div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-2">
					...
					<div class="col-span-12 md:col-span-6">
						...
						<div class="relative w-full">
							...
							<input wire:model.defer="bid_amount" x-on:keyup="calculateProfit" x-on:change="verifyAmount"
								...
								class="{{ $errors->first('bid_amount') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-lg font-medium block w-full ltr:pr-12 rtl:pl-12 p-4  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
								placeholder="0.00">
					...
					<div class="col-span-12 md:col-span-6">
						...
						<label for="bid-amount-paid-input"
							...
							<svg data-tooltip-target="bid-paid-to-you-tooltip"
								class="cursor-pointer w-4 h-4 text-gray-400" stroke="currentColor" fill="currentColor"
					...
					<div class="col-span-12">
						...
						<div class="relative w-full">
							...
							<input type="text" wire:model.defer="bid_days" id="bid-days-input"
								class="{{ $errors->first('bid_days') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-lg font-medium block w-full ltr:pr-12 rtl:pl-12 p-4  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
					...
					<div class="col-span-12">
						...
						<label for="bid-description-input"
							class="{{ $errors->first('bid_description') ? 'text-red-600' : 'text-gray-900' }} block mb-2 text-[13px] font-bold dark:text-white">
						...
						<div class="relative w-full">
							...
							<textarea wire:model.defer="bid_description" id="bid-description-input"
								...
								rows="8"
								placeholder="{{ __('messages.t_describe_ur_proposal_placeholder') }}"></textarea>
					...
					<div class="space-y-2 divide-y divide-gray-200 dark:divide-zinc-700 w-full">
						...
						<div class="relative flex items-center w-full py-4">
							<div class="flex items-center h-5">
								<input id="bid-promotion-plan-{{ $plan->uid }}" name="bidding_selected_plans"
									wire:model.defer="bid_{{ $plan->plan_type }}" value="{{ $plan->uid }}"
									type="checkbox"
							...
							<div class="ltr:ml-4 rtl:mr-4 text-sm w-full">
								<label for="bid-promotion-plan-{{ $plan->uid }}"
									...
									<div class="inline-flex px-2 py-1 rounded-full text-xs font-medium tracking-widest uppercase min-w-[120px] justify-center"
										style="color: {{ $plan->badge_text_color }};background-color: {{ $plan->badge_bg_color }};">
										@lang('messages.t_' . $plan->plan_type)
									</div>

									{{-- Price --}}
									<span
										class="text-sm font-semibold text-zinc-700 bg-gray-100 rounded-md px-3 py-2 dark:bg-zinc-900 dark:text-zinc-200">@money($plan->price,
										settings('currency')->code, true)</span>
		...
		{{-- Share project --}}
		<x-forms.modal id="modal-share-project-container" target="modal-share-project-button" uid="modal_{{ uid() }}"
				...
				<div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-6">
					...
					<div class="col-span-12">
						<div class="mt-1 relative flex items-center">
							<input type="text" id="input-project-url-share" value="{{ url()->current() }}"
					...
					<div class="col-span-12">
						<ul class="flex items-center justify-center space-x-3 rtl:space-x-reverse">
							...
							{{-- Facebook --}}
							<li>
								<a href="https://www.facebook.com/share.php?u={{ url()->current() }}&t={{ $project->title }}"
									target="_blank"
							...
							{{-- Twitter --}}
							<li>
								<a href="https://twitter.com/intent/tweet?text={{ $project->title }}%20-%20{{ url()->current() }}%20"
									target="_blank"
							...
							{{-- Linkedin --}}
							<li>
								<a href="https://www.linkedin.com/shareArticle?mini=true&url={{ url()->current() }}&title={{ $project->title }}&summary={{ $project->title }}"
									target="_blank"
		...
		<x-forms.modal id="modal-report-project-container" target="modal-report-project-button" uid="modal_{{ uid() }}"
			placement="center-center" size="max-w-xl">
					...
					<div class="col-span-12">
						<fieldset class="w-full">
							<div class="space-y-4">
								...
								{{-- List of reasons --}}
								@for ($i = 1; $i <= 6; $i++) <div class="flex items-center">
									<input wire:model.defer="report_reason" value="reason_{{ $i }}"
										id="report_project_reason_{{ $i }}" name="report_reason" type="radio"
										class="focus:ring-primary-600 h-4 w-4 text-primary-700 border-gray-300">
									<label for="report_project_reason_{{ $i }}"
				...
				<div class="col-span-12">
					...
					<div class="relative w-full">
						...
						<textarea wire:model.defer="report_description" id="bid-report-description-input"
							...
							rows="8" placeholder="{{ __('messages.t_enter_issue_description') }}"></textarea>
