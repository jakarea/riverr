                ...
                @foreach ($links as $link)
                    ...
                    @if (!$link['childs'])
                        ...
                        <li class="relative px-4 flex items-center group py-2">
                            <a href="{{ $link['href'] }}" class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100 hover:bg-[#F0EEFF] rounded-full py-1 px-2">
                                ...
                                {{-- Text --}}
                                <span class="ltr:ml-4 rtl:mr-4 text-[15px] font-medium text-gray-600 group-hover:text-gray-900">{{ $link['text'] }}</span>
                                ...
                                <ul x-transition:enter="transition-all ease-in-out duration-300"
                                    ...
                                    @foreach ($link['childs'] as $child)
                                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                            <a class="w-full block font-medium text-[#14px]" href="{{ $child['href'] }}">{{ $child['text'] }}</a>
                                        </li>
                                    @endforeach
