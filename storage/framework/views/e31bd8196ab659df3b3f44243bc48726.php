            ...
            <div class="col-span-12 mt-6 xl:mt-6 mb-16">
                ...
                <div class="flex w-9/12 justify-center mx-auto mt-12" wire:ignore>
                    ...
                    <a href="<?php echo e(url('categories', $category->slug), false); ?>" 
                        class="bg-white ease-in-out p-6 rounded-3xl mx-3 w-1/3" style="box-shadow: 0px 7px 22px 0px rgba(143, 134, 195, 0.07)">
                        <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($category->image), false); ?>" alt="<?php echo e($category->name, false); ?>" class="lazy w-20 h-20 rounded-lg mb-5">

                        <h5 class="text-[#363848] font-semibold text-3xl"><?php echo e($category->name, false); ?></h5>
                        <p class="text-[#363848] font-normal text-base mt-4"><?php echo e($category->description, false); ?></p> 
                    </a>
            ...
            <div class="col-span-12 mb-16">
                ...
                <div class="block mb-6">
                    <div class="flex justify-between items-center bg-transparent py-2">
                        ...
                        <div>
                            <span class="font-extrabold text-2xl text-gray-800 dark:text-gray-100 pb-1 block tracking-wider">
                                <?php echo app('translator')->get('messages.t_latest_projects'); ?>    
                            </span>
                        </div>

                        <div>
                            <a href="<?php echo e(url('explore/projects'), false); ?>" class="text-white hover:text-[#363848] transition-colors duration-300 hidden rounded-full md:block dark:text-gray-100 dark:hover:text-white bg-[#5F4BDB] font-semibold text-base py-3 px-10 ml-4 hover:bg-[#F0EEFF] min-w-fit">
                                <?php echo e(__('messages.t_view_more'), false); ?>
...
?>
        ...
        <?php if(settings('newsletter')->is_enabled): ?>
            <div class="col-span-12">
                <div class="bg-[#1F2131] relative z-10 dark:bg-zinc-800 rounded-md flex items-center py-24 px-20">
                    <div class="w-full flex items-center">
                        <h3 class="text-white text-[44px] font-semibold w-3/5"><?php echo e(__('messages.t_dont_miss'), false); ?></h3> 
                        <div class="mt-4 sm:mt-6 sm:flex w-2/5 relative">
                            <label for="email-address" class="sr-only">Email address</label>
                            <input wire:model.defer="email" id="email-address" type="text" autocomplete="email" required="" placeholder="<?php echo e(__('messages.t_enter_email_address'), false); ?>" class="h h-[4.5rem] appearance-none min-w-0 w-full bg-transparent dark:bg-zinc-700 border border-[#363843] dark:border-zinc-700 placeholder:text-secondary-100 focus:outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-600 rounded-full text-white text-lg pl-6" readonly onfocus="this.removeAttribute('readonly');">
                            <div class="absolute right-2 top-2">
                                <button wire:click="newsletter" wire:loading.attr="disabled" wire:target="newsletter" type="button" class="dark:disabled:bg-zinc-500 dark:disabled:text-zinc-400 disabled:cursor-not-allowed disabled:!bg-gray-400 disabled:text-gray-500 h-14 w-full bg-[#FE8D4D] rounded-full py-2 px-4 flex items-center justify-center text-sm font-bold tracking-wider text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-primary-600">
                                    <?php echo e(__('messages.t_subscribe'), false); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/main/home/home.blade.php ENDPATH**/ ?>