<footer class="bg-[#1F2131] dark:bg-zinc-800 px-4 sm:px-6 lg:px-32 pt-20 pb-10 lg:pb-20 relative z-10">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:gap-x-6 gap-y-6 mb-10 lg:grid-cols-12 md:grid-cols-6 sm:grid-cols-2">
            ...
            <div class="col-span-3">
                ...
                <div class="text-xl text-white font-semibold mb-2 dark:text-white tracking-widest">
                            ...
                            <?php if($page->column == 1): ?>
                                <li>
                                    <?php if($page->is_link && $page->link): ?>
                                        <a href="<?php echo e($page->link, false); ?>" target="_blank" class="text-base block font-normal text-white mt-5 hover:ml-1 transition-all dark:text-white">
                                            <?php echo e($page->title, false); ?>

                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(url('page', $page->slug), false); ?>" class="text-base block font-normal text-white mt-5 hover:ml-1 transition-all dark:text-white">
                                            <?php echo e($page->title, false); ?>
        ...
        <div class="grid md:flex justify-center md:justify-between items-center border-t border-gray-600 dark:border-zinc-700 pt-4">
        ...
        <div class="text-center mt-10">
            ...
            <div class="flex space-x-4 justify-center rtl:space-x-reverse">
                ...
                <a href="<?php echo e(url('help/contact'), false); ?>" class="text-xs font-medium uppercase text-gray-400 dark:text-gray-400 dark:hover:text-gray-100 hover:underline"><?php echo e(__('messages.t_contact_us'), false); ?></a>

                
                <?php if(settings('footer')->privacy): ?>
                    <a href="<?php echo e(url('page', settings('footer')->privacy->slug), false); ?>" class="text-xs font-medium uppercase text-gray-400 dark:text-gray-400 dark:hover:text-gray-100 hover:underline"><?php echo e(__('messages.t_privacy_policy'), false); ?></a>
                <?php endif; ?>

                
                <?php if(settings('footer')->terms): ?>
                    <a href="<?php echo e(url('page', settings('footer')->terms->slug), false); ?>" class="text-xs font-medium uppercase text-gray-400 dark:text-gray-400 dark:hover:text-gray-100 hover:underline"><?php echo e(__('messages.t_terms_of_service'), false); ?></a>
                <?php endif; ?>

                
                <?php if(settings('blog')->enable_blog): ?>
                    <a href="<?php echo e(url('blog'), false); ?>" class="text-xs font-medium uppercase text-gray-400 dark:text-gray-400 dark:hover:text-gray-100 hover:underline"><?php echo e(__('messages.t_blog'), false); ?></a>
                <?php endif; ?>
...
</footer><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/main/includes/footer.blade.php ENDPATH**/ ?>