...
<button 
    ...
    class="{{ $block ? 'w-full' : '' }} text-base font-semibold flex justify-center {{ $active }} py-4 px-8 rounded-full tracking-wide focus:outline-none focus:shadow-outline cursor-pointer"
    {{ $attributes }}
    >
