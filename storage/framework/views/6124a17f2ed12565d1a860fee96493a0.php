...
<div id="<?php echo e($id, false); ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto fixed top-0 right-0 left-0 z-[60] w-full md:inset-0 h-modal md:h-full" wire:ignore.self x-data="window.<?php echo e($uid, false); ?>" x-init="initialize">
    <div class="relative p-4 w-full <?php echo e($size, false); ?> h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-3xl shadow dark:bg-zinc-800">
            
            
            <?php if($title ?? null): ?>
                <div class="flex justify-between items-center py-5 px-6 rounded-t-2xl border-b border-gray-100 dark:border-zinc-600 dark:bg-transparent bg-white">
            ...
            <?php if($footer ?? null): ?>
                <div class="bg-white dark:bg-zinc-700/40 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse rounded-b-2xl">
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/components/forms/modal.blade.php ENDPATH**/ ?>