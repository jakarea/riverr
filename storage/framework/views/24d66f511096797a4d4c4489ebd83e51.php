...
<div>
    ...
    <?php if($label): ?>
        <label for="textarea-input-component-id-<?php echo e($model, false); ?>" class="block text-base font-medium <?php echo e($errors->first($model) ? 'text-red-600 dark:text-red-500' : 'text-[#1F2131] dark:text-white', false); ?>"><?php echo e(htmlspecialchars_decode($label), false); ?></label>
    <?php endif; ?>
...
</div><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/components/forms/textarea.blade.php ENDPATH**/ ?>