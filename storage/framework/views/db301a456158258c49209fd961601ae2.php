...
<div>
    ...
    <?php if($label): ?>
        <label for="text-input-component-id-<?php echo e($model, false); ?>" class="block text-base font-medium <?php echo e($errors->first($model) ? 'text-red-600 dark:text-red-500' : 'text-[#1F2131] dark:text-white', false); ?>"><?php echo e(htmlspecialchars_decode($label), false); ?></label>
    <?php endif; ?>
    ...
    <div class="<?php echo e($label ? 'mt-2.5' : '', false); ?> relative">
        ...
        <input 
            ...
            class="disabled:cursor-not-allowed focus:!ring-1 block w-full ltr:pr-10 ltr:pl-4 rtl:pl-10 rtl:!pr-4 py-3.5 placeholder:font-normal placeholder:text-[13px] dark:placeholder-zinc-300 text-base bg-[#FBFBFB] font-normal text-[#363848] h-14 dark:text-white rounded-full dark:bg-transparent <?php echo e($errors->first($model) ? 'focus:!ring-red-600 focus:!border-red-600 border-red-500' : 'focus:!ring-primary-600 focus:!border-primary-600 border-[#C2C2C2] dark:border-zinc-500', false); ?>" 
...
</div><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/components/forms/text-input.blade.php ENDPATH**/ ?>