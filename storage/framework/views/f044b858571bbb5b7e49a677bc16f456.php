<header class="dark:bg-[#0f0f0f] w-full z-40 transition-all duration-200 bg-[#F8F9FD] font-body">
    <div x-data="window.TTRjRvxLbHzaKxW">

        
        <?php if(auth()->guard('admin')->check()): ?>
        <div class="bg-[#5F4BDB] dark:bg-primary-600">
            <div class="max-w-screen-2xl mx-auto h-10 flex items-center justify-between sm:px-6 px-4 lg:px-16">
                ...
                <div class="flex items-center space-x-6 rtl:space-x-reverse mr-4">
        ...
        <nav
            class="relative container max-w-screen-xl md:max-w-7xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-16 justify-between items-center h-20 flex py-4">
            ...
            <a href="<?php echo e(url('/'), false); ?>" class="block ltr:sm:mr-6 rtl:sm:ml-6">
                <img width="150" height="<?php echo e(settings('appearance')->sizes['header_desktop_logo_height'], false); ?>"
                    src="<?php echo e(src(settings('general')->logo_dark), false); ?>" alt="<?php echo e(settings('general')->title, false); ?>"
                    style="height: <?php echo e(settings('appearance')->sizes['header_desktop_logo_height'], false); ?>px;width:auto">
            </a>
            <?php else: ?>
            <a href="<?php echo e(url('/'), false); ?>" class="block ltr:sm:mr-6 rtl:sm:ml-6">
                <img width="150" height="<?php echo e(settings('appearance')->sizes['header_desktop_logo_height'], false); ?>"
                    src="<?php echo e(src(settings('general')->logo), false); ?>" alt="<?php echo e(settings('general')->title, false); ?>"
                    style="height: <?php echo e(settings('appearance')->sizes['header_desktop_logo_height'], false); ?>px;width:auto">
            </a>
            <?php endif; ?>
            ...
            <div class="flex">
                ...
                <a href="<?php echo e(url('/'), false); ?>"
                    class="text-[#363848] hover:text-[#5F4BDB] transition-colors duration-300 py-2 pr-8 hidden md:block dark:text-gray-100 dark:hover:text-white">
                ...
                <a href="<?php echo e(url('/blog'), false); ?>"
                    class="text-[#363848] hover:text-[#5F4BDB] transition-colors duration-300 py-2 pr-8 hidden md:block dark:text-gray-100 dark:hover:text-white">
                    <?php echo app('translator')->get('messages.t_blog'); ?>
                </a>
                <a href="<?php echo e(url('start_selling'), false); ?>"
                    class="text-[#363848] hover:text-[#5F4BDB] transition-colors duration-300 py-2 hidden md:block dark:text-gray-100 dark:hover:text-white">
                    <?php echo app('translator')->get('messages.t_become_a_member'); ?>
                </a>
            </div>
            <?php endif; ?>
            ...
            !Illuminate\Support\Str::of(request()->path())->startsWith('seller')): ?>

            
            

            <?php elseif(auth()->user()->account_type === 'seller' &&
            Illuminate\Support\Str::of(request()->path())->startsWith('seller')): ?>

            
            <a href="<?php echo e(url('/'), false); ?>"
                class="text-primary-600 hover:text-primary-700 transition-colors duration-300 py-2 px-4 hidden lg:block dark:text-gray-100 dark:hover:text-white">
            ...
            <div
                ...
                <div class="w-full hidden lg:block">
                    <div class="relative max-w-lg" x-data="{ open: false }">
                        ...
                        <input wire:model.debounce.500ms="q" wire:keydown.enter="enter" x-ref="search"
                            ...
                            class="block p-2.5 z-20 text-sm text-[#818181] dark:text-white bg-white dark:bg-[#181818] rounded-full dark:border-[#181818] focus:ring-0 focus:border-gray-500 h-12 border-0 pl-3 font-normal w-80"
                            placeholder="<?php echo e(__('messages.t_search_here'), false); ?>" required>

                        
                        <button type="button" wire:click="enter"
                            class="flex items-center justify-center absolute top-1 right-2 rtl:left-1 p-2.5 text-dark bg-white hover:bg-zinc-800 h-10  rounded-full border-0 hover:text-white hover:border-zinc-800">
                        ...
                        <div class="absolute top-16 w-full bg-white dark:bg-zinc-800 rounded-lg border border-gray-100 dark:border-zinc-800 shadow-md max-w-full z-[60]"
                            ...
                            <ul class="max-h-80 scroll-py-10 scroll-pb-2 space-y-4 overflow-y-auto p-4 pb-2"
                                    ...
                                    <ul class="-mx-4 mt-2 text-sm text-gray-700 dark:text-gray-400">
                                        ...
                                        <li class="group flex cursor-default select-none items-center px-4 py-2">
                                            <a href="<?php echo e(url('service', $gig->slug), false); ?>" class="flex items-center">
                                                ...
                                                <span
                                                    class="ltr:ml-3 rtl:mr-3 flex-auto ext-ellipsis overflow-hidden"><?php echo e($gig->title, false); ?></span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="-mx-4 mt-2 text-sm text-gray-700 dark:text-gray-400">
                                        ...
                                        <li class="group flex cursor-default select-none items-center px-4 py-2">
                                            <a href="<?php echo e(url('profile', $seller->username), false); ?>" class="flex items-center">
                                                <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($seller->avatar), false); ?>"
                                                    alt="<?php echo e($seller->username, false); ?>"
                            ...
                            <div class="py-14 px-6 text-center text-sm sm:px-14">
                                ...
                                <p class="mt-2 text-gray-500"><?php echo e(__('messages.t_we_couldnt_find_anthing_search_term'), false); ?>
                ...
                <a href="<?php echo e(url('auth/login'), false); ?>"
                    class="text-[#363848] hover:text-white transition-colors duration-300 hidden rounded-full md:block dark:text-gray-100 dark:hover:text-white bg-[#F0EEFF] font-semibold text-base py-3 px-10 hover:bg-[#5F4BDB] ml-4">
                    <?php echo app('translator')->get('messages.t_login'); ?>
                </a>
                <a href="<?php echo e(url('auth/register'), false); ?>"
                    class="text-white hover:text-[#363848] transition-colors duration-300 hidden rounded-full md:block dark:text-gray-100 dark:hover:text-white bg-[#5F4BDB] font-semibold text-base py-3 px-10 ml-4 hover:bg-[#F0EEFF] min-w-fit">
                    <?php echo app('translator')->get('messages.t_sign_up'); ?>
                </a>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l228699755-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l228699755-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l228699755-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l228699755-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l228699755-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                ...
                <button x-on:click="notifications_menu = true" type="button"
                    class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 relative mx-4 dark:text-gray-100 dark:hover:text-white hidden md:block">
                ...
                <?php if(auth()->guard()->check()): ?>
                <div class="hidden md:inline-block relative ltr:ml-2 rtl:mr-4" x-data="{ open: false }">

                    
                    <?php if(auth()->user()->isOnline() && !auth()->user()->availability): ?>
                    <div
                        class="absolute top-0 ltr:right-0 rtl:left-0 w-3 h-3 rounded-full bg-green-400 border-2 border-white dark:border-transparent">
                    </div>
                    <?php elseif(auth()->user()->availability): ?>
                    <div
                        class="absolute top-0 ltr:right-0 rtl:left-0 w-3 h-3 rounded-full bg-gray-400 border-2 border-white dark:border-transparent">
                    </div>
                    <?php else: ?>
                    <div
                        class="absolute top-0 ltr:right-0 rtl:left-0 w-3 h-3 rounded-full bg-red-400 border-2 border-white dark:border-transparent">
                    </div>
                    <?php endif; ?>

                    
                    <?php if(auth()->user()->avatar): ?>
                    <img x-on:click="open = !open" src="<?php echo e(placeholder_img(), false); ?>"
                        data-src="<?php echo e(src(auth()->user()->avatar), false); ?>" alt="<?php echo e(auth()->user()->username, false); ?>"
                        class="lazy block w-12 h-8 rounded-full cursor-pointer object-cover">
                    <?php else: ?>
                    <div x-on:click="open = !open"
                        class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 dark:bg-zinc-500 text-gray-300 dark:text-zinc-400 cursor-pointer">
                        <svg class="hi-solid hi-user inline-block w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div x-show="open" style="display: none" x-transition:enter="transition ease-out duration-150"
                        ...
                        <p class="py-3 px-3.5 truncate">
                            <span class="block mb-0.5 text-xs text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_logged_in_as_username', ['username' => auth()->user()->username]), false); ?></span>
                            <span class="font-semibold dark:text-white"><?php echo money(auth()->user()->balance_available,
                        ...
                        <div class="p-0">
                            ...
                            <a href="<?php echo e(url('start_selling'), false); ?>"
                                class="group flex items-center justify-between px-4 py-2 group-hover:text-primary-600 group-hover:bg-primary-600 hover:bg-[#F0EEFF]">

                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('Become a seller'), false); ?></span>

                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="flex-none rtl:ml-3 text-gray-400 group-hover:text-primary-600 h-5 w-5"
                        ...
                        <div class="p-o">
                            ...
                            <a href="<?php echo e(url('account/projects'), false); ?>"
                                class="group flex items-center justify-between px-4 py-2 group-hover:text-primary-600 group-hover:bg-primary-600 hover:bg-[#F0EEFF]">

                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">
                            ...
                            <?php if(settings('projects')->who_can_post === 'both' || settings('projects')->who_can_post ===
                        ...
                        <div class="p-0">
                            <a href="<?php echo e(url('account/offers'), false); ?>"
                                class="group flex items-center justify-between px-4 py-2 group-hover:text-primary-600 group-hover:bg-primary-600 hover:bg-[#F0EEFF]">
                                ...
                                <svg class="flex-none rtl:ml-3 text-gray-400 group-hover:text-primary-600 h-5 w-5"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="p-0">
                            ...
                            <a href="<?php echo e(url('account/password'), false); ?>"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_update_password'), false); ?></span>
                        ...
                        <div class="p-0">
                            ...
                            <a href="<?php echo e(url('account/deposit'), false); ?>"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_deposit'), false); ?></span>
                            ...
                            <a href="<?php echo e(url('account/reviews'), false); ?>"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_reviews'), false); ?></span>
                            ...
                            <a href="<?php echo e(url('account/refunds'), false); ?>"
                                ...
                                <span
                                    class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_refunds'), false); ?></span>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 hidden md:block">
            ...
            <div data-popover id="popover-subcategories-<?php echo e($category->uid, false); ?>" data-popover-placement="bottom"
                role="tooltip"
                ...
                <ul
                    ...
                    <li class="first:rounded-t-md">
                        <a href="<?php echo e(url('categories/' . $category->slug . '/' . $sub->slug), false); ?>"
                            class="flex items-center py-2 px-3 hover:bg-gray-50 dark:hover:bg-zinc-700"
                            style="border-radius: inherit">
                            <?php if($sub->icon): ?>
                            <div class="flex-shrink-0 ltr:mr-2 rtl:ml-2">
                                <img class="w-7 h-7 lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($sub->icon), false); ?>"
                                    alt="<?php echo e($sub->name, false); ?>">
                            </div>
                            <?php endif; ?>
            ...
            <div x-show="mobile_menu" style="display: none"
                ...
                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['w-full overflow-auto h-full', 'pt-5'=> auth()->check()]); ?>">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->account_type === 'seller'): ?>
                        <a href="<?php echo e(url('seller/orders'), false); ?>"
                            class="text-gray-500 hover:text-primary-600 dark:text-gray-100 dark:hover:text-white transition-colors duration-300 py-2 mx-4 relative md:hidden">
                            <svg class="text-gray-400 hover:text-gray-700 h-6 w-6 dark:text-gray-100 dark:hover:text-white"
                                stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
...
<?php endif; ?>
                    ...
                    <a href="<?php echo e(url('search'), false); ?>"
                        class="py-2 px-5 block text-gray-500 dark:text-gray-200 font-semibold text-sm">
                        ...
                        <div x-show="open" style="display: none" x-transition:enter="transition ease-out duration-100"
                            ...
                            <details class="group ltr:ml-4 rtl:mr-4" wire:key="header-categories-<?php echo e($category->uid, false); ?>">
                                ...
                                <summary class="flex items-center text-gray-500 dark:text-gray-300 py-2 px-5">
                                    ...
                                    <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($category->icon), false); ?>"
                                        alt="<?php echo e($category->name, false); ?>" class="lazy h-6 w-6 rounded-full object-contain">

                                    
                                    <span class="ltr:ml-3 rtl:mr-3 text-[13px] font-medium"> <?php echo e($category->name, false); ?>
                                ...
                                <nav class="mt-1.5 ltr:ml-8 rtl:mr-8 flex flex-col">
                                    ...
                                    <a href="<?php echo e(url('categories/' . $category->slug), false); ?>"
                                        ...
                                        <span class="ltr:ml-3 rtl:mr-3 text-xs font-medium"> <?php echo e(__('messages.t_browse_parent_category', ['category' => $category->name]), false); ?>
                    ...
                    <div x-data="{ open: false }" class="space-y-1">
                        ...
                        <div x-show="open" style="display: none" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div <?php if($default_language_code !==$lang->language_code): ?> wire:click="setLocale('<?php echo e($lang->language_code, false); ?>')" <?php endif; ?> class="py-2 px-5 rounded-sm inline-flex items-center
                                cursor-pointer justify-between <?php echo e($default_language_code === $lang->language_code ?
                                'bg-primary-100/25 text-primary-600' : 'hover:bg-gray-50 dark:hover:bg-zinc-600', false); ?>
                            ...
                            <div class="flex items-center bg-slate-100 px-4 py-2 rounded dark:bg-zinc-600">
                                ...
                                <div class="ltr:ml-3 rtl:mr-3 w-0 flex-1">
                                    ...
                                    <div class="mt-2 flex space-x-7 rtl:space-x-reverse">
                                        ...
                                        <a href="<?php echo e($n->action, false); ?>"
                                        ...
                                        <button wire:click="readNotification('<?php echo e($n->uid, false); ?>')"
                                            wire:loading.attr="disabled" wire:target="read('<?php echo e($n->uid, false); ?>')"
                                            type="button"
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>