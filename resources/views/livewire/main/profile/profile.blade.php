                ...
                <div class="flex items-center md:space-x-5 rtl:space-x-reverse flex-col md:flex-row">
                    ...
                    <div class="flex-shrink-0 mb-5 md:mb-0">
                        <div class="inline-block relative">
                            <img src="{{ placeholder_img() }}" data-src="{{ src($user->avatar) }}" alt="{{ $user->username }}" class="inline-block lg:w-32 lg:h-32 rounded-full object-cover lazy h-8 w-8">
                        </div>
                    </div>
                    ...
                    <div>
                            ...
                            <div class="flex items-center mb-2 justify-center md:justify-normal">
                                ...
                                @if ($user->fullname)
                                    <h1 class="text-base lg:text-2xl font-extrabold text-gray-700 dark:text-zinc-100 mb-2">{{ $user->fullname }}</h1>
                                @else
                                    <h1 class="text-base lg:text-2xl font-extrabold text-gray-700 dark:text-zinc-100 mb-2">{{ $user->username }}</h1>
                                @endif
                            ...
                            <div class="flex items-center md:space-x-3 rtl:space-x-reverse mb-4 md:mb-0 justify-center md:justify-normal space-y-1 md:space-y-0 flex-col md:flex-row">
                                ...
                                {{-- Level --}}
                                @if ($user->level)
                                    <span class="inline-flex items-center rounded-full bg-transparent border px-4 py-1 text-md font-normal tracking-wide" style="color: {{ $user->level->level_color }}; border-color: {{ $user->level->level_color }};">
                ...
                @if ($user->description)
                    <section class="px-7">
                        ...
                        <div class="mb-3" id="about-me-element">
                            <h1 class="text-lg font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100">@lang('messages.t_about_me')</h1>
                        </div>

                        {{-- Section body --}}
                        <div class="text-md text-gray-500 dark:text-zinc-400 leading-relaxed {{ $enable_more_less ? 'max-h-16 overflow-hidden' : '' }}" id="profile-description-content">
