<div class="w-full md:max-w-5xl mx-auto block" x-data="window.rxhfJIyOMMqiyHB">
    ...
    <div class="w-full">
        ...
        <div class=" shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none 
        py-5 mb-6 dark:bg-zinc-800 px-2 rounded-xl bg-white" style="box-shadow: 0px 2px 28px rgba(62, 53, 120, 0.04)">
                ...
                <div class="flex items-center md:space-x-5 rtl:space-x-reverse flex-col md:flex-row">
                    ...
                    <div class="flex-shrink-0 mb-5 md:mb-0">
                        <div class="inline-block relative">
                            <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($user->avatar), false); ?>" alt="<?php echo e($user->username, false); ?>" class="inline-block lg:w-32 lg:h-32 rounded-full object-cover lazy h-8 w-8">
                        </div>
                    </div>
                    ...
                    <div>
                            ...
                            <div class="flex items-center mb-2 justify-center md:justify-normal">
                                ...
                                <?php if($user->fullname): ?>
                                    <h1 class="text-base lg:text-2xl font-extrabold text-gray-700 dark:text-zinc-100 mb-2"><?php echo e($user->fullname, false); ?></h1>
                                <?php else: ?>
                                    <h1 class="text-base lg:text-2xl font-extrabold text-gray-700 dark:text-zinc-100 mb-2"><?php echo e($user->username, false); ?></h1>
                                <?php endif; ?>
                            ...
                            <div class="flex items-center md:space-x-3 rtl:space-x-reverse mb-4 md:mb-0 justify-center md:justify-normal space-y-1 md:space-y-0 flex-col md:flex-row">
                                ...
                                <?php if($user->level): ?>
                                    <span class="inline-flex items-center rounded-full bg-transparent border px-4 py-1 text-md font-normal tracking-wide" style="color: <?php echo e($user->level->level_color, false); ?>; border-color: <?php echo e($user->level->level_color, false); ?>;">
                                ...
                                <?php if($user->account_type === 'seller' && !$user->availability): ?>
                                    <span class="inline-flex items-center rounded-full bg-transparent border border-purple-500 px-4 py-1 text-md font-normal tracking-wide text-purple-500 whitespace-nowrap">
                                ...
                                <?php if($user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded-full bg-transparent border border-green-500 px-4 py-1 text-md font-normal tracking-wide text-green-500 whitespace-nowrap">
                                ...
                                <?php if(!$user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded-full bg-transparent border border-red-500 px-4 py-1 text-md font-normal tracking-wide text-red-500 whitespace-nowrap">
                ...
                <div class="flex items-center space-x-2 rtl:space-x-reverse justify-center md:justify-normal">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->id() != $user->id): ?>
                            <div class="w-9 h-9">
                                <a href="<?php echo e(url('messages/new', $user->username), false); ?>" data-tooltip-target="tooltip-profile-page-contact-user" class="text-zinc-400 hover:text-zinc-500 bg-white hover:bg-gray-100 border border-gray-200 cursor-pointer rounded-full focus:outline-none h-10 w-10 flex items-center justify-center dark:border-zinc-700 dark:bg-zinc-700/40 dark:text-zinc-400 dark:hover:bg-zinc-800">
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-y-6">
            ...
            <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg dark:bg-zinc-800 divide-y dark:divide-zinc-700 space-y-8 h-fit pb-8">
                ...
                <section class="px-5 pt-8 rounded-lg" style="box-shadow: 0px 2px 28px rgba(62, 53, 120, 0.04)">

                    
                    <ul class="list-inside text-gray-500 dark:text-zinc-300 text-base space-y-3">
            ...
            <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg dark:bg-zinc-800 col-span-2 py-6 divide-y dark:divide-zinc-700 space-y-8" style="box-shadow: 0px 2px 28px rgba(62, 53, 120, 0.04)">
                ...
                <?php if($user->description): ?>
                    <section class="px-7">
                        ...
                        <div class="mb-3" id="about-me-element">
                            <h1 class="text-lg font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_about_me'); ?></h1>
                        </div>

                        
                        <div class="text-md text-gray-500 dark:text-zinc-400 leading-relaxed <?php echo e($enable_more_less ? 'max-h-16 overflow-hidden' : '', false); ?>" id="profile-description-content">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\riverr\resources\views/livewire/main/profile/profile.blade.php ENDPATH**/ ?>