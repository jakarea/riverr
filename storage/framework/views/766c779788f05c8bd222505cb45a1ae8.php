...
} elseif ($_instance->childHasBeenRendered('iZPzFmV')) {
    $componentId = $_instance->getRenderedChildComponentId('iZPzFmV');
    $componentTag = $_instance->getRenderedChildComponentTagName('iZPzFmV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iZPzFmV');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('iZPzFmV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('6VpqHTp')) {
    $componentId = $_instance->getRenderedChildComponentId('6VpqHTp');
    $componentTag = $_instance->getRenderedChildComponentTagName('6VpqHTp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6VpqHTp');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('6VpqHTp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://riverr.local/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>