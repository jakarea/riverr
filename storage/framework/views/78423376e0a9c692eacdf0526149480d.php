...
} elseif ($_instance->childHasBeenRendered('tqqKi5y')) {
    $componentId = $_instance->getRenderedChildComponentId('tqqKi5y');
    $componentTag = $_instance->getRenderedChildComponentTagName('tqqKi5y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tqqKi5y');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('tqqKi5y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('nlV1oXT')) {
    $componentId = $_instance->getRenderedChildComponentId('nlV1oXT');
    $componentTag = $_instance->getRenderedChildComponentTagName('nlV1oXT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nlV1oXT');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('nlV1oXT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>