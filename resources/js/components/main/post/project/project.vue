<template>
    <div class="w-full md:max-w-3xl mx-auto">
        ...
        <div class="w-full relative">
            ...
            <!-- Form -->
            <div class="bg-white rounded-xl mt-4 px-5 py-6 md:px-12 md:py-8 mb-8 dark:bg-zinc-800 dark:shadow-none" style="box-shadow: 0px 7px 22px 0px rgba(143, 134, 195, 0.07)">
                ...
                <div class="text-center mb-16">
                    ...
                    <h3 class="mt-4 text-2xl font-semibold tracking-wide text-gray-800 dark:text-zinc-100" v-text="__('t_post_new_project')"></h3>
                    <p class="mt-1 text-md text-gray-500 dark:text-zinc-400" v-text="__('t_post_new_project_subtitle')"></p>
                </div>
                ...
                <div class="grid grid-cols-12 gap-y-8 gap-x-5" id="section-main-details">
                    ...
                    <div class="col-span-12 select2-form-wrapper">
                        ...
                        <!-- Select -->
                        <div class="w-full rounded-full shadow-sm">
                            <select v-model="form.category" id="select2-categories" class="rounded-full">
            ...
            <!-- Badget section -->
            <div class="bg-white rounded-xl mt-4 shadow px-5 py-6 md:px-12 md:py-8 mb-8 dark:bg-zinc-800 dark:shadow-none"  style="box-shadow: 0px 7px 22px 0px rgba(143, 134, 195, 0.07)">
                <div class="grid grid-cols-12 gap-y-8 gap-x-5">

                    <!-- Budget section heading -->
                    <div class="col-span-12">
                        <h3 class="mt-2 text-xl font-semibold tracking-wide text-gray-800 dark:text-white" v-text="__('t_budget')"></h3>
                        <p class="mt-1 text-md text-gray-500 dark:text-zinc-300" v-text="__('t_how_do_u_want_to_pay')"></p>
                    </div>

                    <!-- How do you want to pay -->
                    <div class="col-span-12" id="section-budget"> 
                        <div class="relative w-full rounded-full h-12 bg-slate-200 dark:bg-zinc-700">

                            <div class="relative w-full h-full flex items-center px-2">

                                <!-- Fixed price -->
                                <div @click="form.salary_type = 'fixed'" class="w-full h-full flex justify-center text-slate-600 dark:text-zinc-300 cursor-pointer text-base font-medium tracking-wide">
                                    <button class="w-full h-full focus:outline-none" v-text="__('t_fixed_price')"></button>
                                </div>

                                <!-- Hourly price -->
                                <div @click="form.salary_type = 'hourly'" class="w-full h-full flex justify-center text-slate-600 dark:text-zinc-300 cursor-pointer text-base font-medium tracking-wide">
                            ...
                            class="bg-white shadow text-base font-semibold flex items-center justify-center w-1/2 rounded-full transition-all duration-150 ease-linear absolute h-10 top-1 text-gray-600 pt-px dark:bg-zinc-900 dark:text-zinc-200"></span>
            ...
            <div class="flex items-center justify-between">
                ...
                <button
                    ...
                    class="w-full bg-primary-600 enabled:hover:bg-primary-700 text-white rounded-full px-8 py-4">
